...
parser.add_argument("--min_df", type=int, help="min_df")
parser.add_argument("--ngram_range_min", type=int, help="ngram_range_min")
parser.add_argument("--ngram_range_max", type=int, help="ngram_range_max")
